 ...
 * generated in the integration.authentication package. 
...
public class ObjectFactory {
    ...
    private final static QName _Authenticate_QNAME = new QName("http://services/", "authenticate");
    private final static QName _AuthenticateResponse_QNAME = new QName("http://services/", "authenticateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: integration.authentication
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "authenticate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "authenticateResponse")
